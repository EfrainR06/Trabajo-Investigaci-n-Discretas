...
\end{figure}
Cada una de estas variantes ofrece distintas fortalezas dependiendo del tipo de grafo, la disponibilidad de datos y los requisitos de escalabilidad o generalización del problema abordado.
\newpage 
